...
function excluir(codigo)
{
	...
	{
		document.location='index.php?modulo=pratos&acao=excluir&cod_prato='+codigo;
	}
}
...
<div class="row">
	<div class="col-md-12">
		...
		while( $dados = $lista_pratos->fetch(PDO::FETCH_ASSOC)  )
		{
			...
			echo '<a class="btn btn-warning btn-xs" href="index.php?modulo=pratos&acao=alterando&cod_prato='.$dados['cod_prato'].'">Alterar</a>';
		...
		echo '<a href="index.php?modulo=pratos&acao=incluindo"  class="btn btn-success">Incluir um Novo Registro</a>';
